...
/**************************************************************/
static int TestProximity(double theNumber, double range) {
...
/********************************************************/
static void DomainErrorMessage(void* theEnv, const char* functionName) {
...
/************************************************************/
static void ArgumentOverflowErrorMessage(void* theEnv,
...
/************************************************************/
static void SingularityErrorMessage(void* theEnv, const char* functionName) {
...
globle double PowFunction(void* theEnv) {
  ...
  if (((DOToDouble(value1) == 0.0) && (DOToDouble(value2) <= 0.0)) ||
...
globle void ModFunction(void* theEnv, DATA_OBJECT_PTR result) {
  ...
  if ((item1.type == FLOAT) || (item2.type == FLOAT)) {
    ...
    result->type = FLOAT;
    result->value =
        (void*)EnvAddDouble(theEnv, fnum1 - (dtrunc(fnum1 / fnum2) * fnum2));
  } else {
...
/*******************************************/
static double genacosh(double num) {
...
/*******************************************/
static double genasinh(double num) {
  return (log(num + sqrt(num * num + 1.0)));
}
...
/*******************************************/
static double genatanh(double num) {
...
/*******************************************/
static double genasech(double num) {
...
/*******************************************/
static double genacsch(double num) {
  return (log(1.0 / num + sqrt(1.0 / (num * num) + 1.0)));
}
