...
#define ProceduralPrimitiveData(theEnv)                 \
  ((struct proceduralPrimitiveData*)GetEnvironmentData( \
      theEnv, PROCEDURAL_PRIMITIVE_DATA))
...
LOCALE EXPRESSION* ParseProcParameters(void*, const char*, struct token*,
                                       EXPRESSION*, SYMBOL_HN**, int*, int*,
                                       int*, int (*)(void*, const char*));
#endif
LOCALE EXPRESSION* ParseProcActions(void*, const char*, const char*,
                                    struct token*, EXPRESSION*, SYMBOL_HN*,
                                    int (*)(void*, EXPRESSION*, void*),
                                    int (*)(void*, EXPRESSION*, void*), int*,
                                    void*);
LOCALE intBool ReplaceProcVars(void*, const char*, EXPRESSION*, EXPRESSION*,
                               SYMBOL_HN*, int (*)(void*, EXPRESSION*, void*),
                               void*);
#if DEFGENERIC_CONSTRUCT
...
LOCALE void PushProcParameters(void*, EXPRESSION*, int, const char*,
