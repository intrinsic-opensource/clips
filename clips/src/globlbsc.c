...
#if !RUN_TIME
  EnvDefineFunction2(theEnv, "get-defglobal-list", 'm',
                     PTIEF GetDefglobalListFunction, "GetDefglobalListFunction",
                     "01w");
  EnvDefineFunction2(theEnv, "undefglobal", 'v', PTIEF UndefglobalCommand,
                     "UndefglobalCommand", "11w");
  EnvDefineFunction2(theEnv, "defglobal-module", 'w',
                     PTIEF DefglobalModuleFunction, "DefglobalModuleFunction",
                     "11w");

#if DEBUGGING_FUNCTIONS
  EnvDefineFunction2(theEnv, "list-defglobals", 'v',
                     PTIEF ListDefglobalsCommand, "ListDefglobalsCommand",
                     "01w");
  EnvDefineFunction2(theEnv, "ppdefglobal", 'v', PTIEF PPDefglobalCommand,
                     "PPDefglobalCommand", "11w");
  AddWatchItem(theEnv, "globals", 0, &DefglobalData(theEnv)->WatchGlobals, 0,
               DefglobalWatchAccess, DefglobalWatchPrint);
#endif
...
/******************************************************/
static void ResetDefglobalAction(void* theEnv,
...
/******************************************/
static void SaveDefglobals(void* theEnv, void* theModule,
...
globle void UndefglobalCommand(void* theEnv) {
  UndefconstructCommand(theEnv, "undefglobal",
                        DefglobalData(theEnv)->DefglobalConstruct);
}
...
globle intBool EnvUndefglobal(void* theEnv, void* theDefglobal) {
  return (Undefconstruct(theEnv, theDefglobal,
                         DefglobalData(theEnv)->DefglobalConstruct));
}
...
globle void GetDefglobalListFunction(void* theEnv,
  ...
  GetConstructListFunction(theEnv, "get-defglobal-list", returnValue,
                           DefglobalData(theEnv)->DefglobalConstruct);
}
...
/*   for the get-defglobal-list function. */
/******************************************/
globle void EnvGetDefglobalList(void* theEnv, DATA_OBJECT_PTR returnValue,
                                void* theModule) {
...
globle void* DefglobalModuleFunction(void* theEnv) {
  return (GetConstructModuleCommand(theEnv, "defglobal-module",
                                    DefglobalData(theEnv)->DefglobalConstruct));
}
...
globle void PPDefglobalCommand(void* theEnv) {
  PPConstructCommand(theEnv, "ppdefglobal",
                     DefglobalData(theEnv)->DefglobalConstruct);
}
...
/*************************************/
globle int PPDefglobal(void* theEnv, const char* defglobalName,
                       const char* logicalName) {
  return (PPConstruct(theEnv, defglobalName, logicalName,
                      DefglobalData(theEnv)->DefglobalConstruct));
}
...
globle void ListDefglobalsCommand(void* theEnv) {
  ListConstructCommand(theEnv, "list-defglobals",
                       DefglobalData(theEnv)->DefglobalConstruct);
}
...
/*   for the list-defglobals command.  */
/***************************************/
globle void EnvListDefglobals(void* theEnv, const char* logicalName,
                              void* vTheModule) {
  struct defmodule* theModule = (struct defmodule*)vTheModule;

  ListConstruct(theEnv, DefglobalData(theEnv)->DefglobalConstruct, logicalName,
                theModule);
}
...
/********************************************************/
globle void EnvSetDefglobalWatch(void* theEnv, unsigned newState,
                                 void* theGlobal) {
#if MAC_XCD
#pragma unused(theEnv)
#endif
...
/********************************************************/
static unsigned DefglobalWatchAccess(void* theEnv, int code, unsigned newState,
                                     EXPRESSION* argExprs) {
#if MAC_XCD
#pragma unused(code)
#endif
  ...
  return (ConstructSetWatchAccess(
      theEnv, DefglobalData(theEnv)->DefglobalConstruct, newState, argExprs,
...
/*********************************************************************/
static unsigned DefglobalWatchPrint(void* theEnv, const char* logName, int code,
                                    EXPRESSION* argExprs) {
#if MAC_XCD
#pragma unused(code)
#endif
  ...
  return (ConstructPrintWatchAccess(
      theEnv, DefglobalData(theEnv)->DefglobalConstruct, logName, argExprs,
      EnvGetDefglobalWatch, EnvSetDefglobalWatch));
}
...
globle void GetDefglobalList(DATA_OBJECT_PTR returnValue, void* theModule) {
  EnvGetDefglobalList(GetCurrentEnvironment(), returnValue, theModule);
}

#if DEBUGGING_FUNCTIONS

globle unsigned GetDefglobalWatch(void* theGlobal) {
  return EnvGetDefglobalWatch(GetCurrentEnvironment(), theGlobal);
}

globle void ListDefglobals(const char* logicalName, void* vTheModule) {
  EnvListDefglobals(GetCurrentEnvironment(), logicalName, vTheModule);
}

globle void SetDefglobalWatch(unsigned newState, void* theGlobal) {
  EnvSetDefglobalWatch(GetCurrentEnvironment(), newState, theGlobal);
}

#endif /* DEBUGGING_FUNCTIONS */

globle intBool Undefglobal(void* theDefglobal) {
