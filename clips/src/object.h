...
struct defclass {
  ...
  unsigned id;
  unsigned busy, hashTableIndex;
  PACKED_CLASS_LINKS directSuperclasses, directSubclasses, allSuperclasses;
  SLOT_DESC *slots, **instanceTemplate;
  unsigned* slotNameMap;
  short slotCount;
  short localInstanceSlotCount;
  short instanceSlotCount;
  short maxSlotNameID;
  INSTANCE_TYPE *instanceList, *instanceListBottom;
  HANDLER* handlers;
...
struct slotName {
  unsigned hashTableIndex, use;
  short id;
  SYMBOL_HN *name, *putHandlerName;
  struct slotName* nxt;
  long bsaveIndex;
};
...
struct instance {
  ...
  unsigned busy;
  DEFCLASS* cls;
  INSTANCE_TYPE *prvClass, *nxtClass, *prvHash, *nxtHash, *prvList, *nxtList;
  INSTANCE_SLOT **slotAddresses, *slots;
};
