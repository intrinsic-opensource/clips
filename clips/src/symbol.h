...
#define ValueToInteger(target) \
  ((int)(((struct integerHashNode*)(target))->contents))
#define ValueToBitMap(target) \
  ((void*)((struct bitMapHashNode*)(target))->contents)
#define ValueToPointer(target) ((void*)target)
#define ValueToExternalAddress(target) \
  ((void*)((struct externalAddressHashNode*)(target))->externalAddress)

#define EnvValueToString(theEnv, target) \
  (((struct symbolHashNode*)(target))->contents)
#define EnvValueToDouble(theEnv, target) \
  (((struct floatHashNode*)(target))->contents)
#define EnvValueToLong(theEnv, target) \
  (((struct integerHashNode*)(target))->contents)
#define EnvValueToInteger(theEnv, target) \
  ((int)(((struct integerHashNode*)(target))->contents))
#define EnvValueToBitMap(theEnv, target) \
  ((void*)((struct bitMapHashNode*)(target))->contents)
#define EnvValueToPointer(theEnv, target) ((void*)target)
#define EnvValueToExternalAddress(theEnv, target) \
  ((void*)((struct externalAddressHashNode*)(target))->externalAddress)
...
#define IncrementExternalAddressCount(theValue) \
  (((EXTERNAL_ADDRESS_HN*)theValue)->count++)
...
#define SymbolData(theEnv) \
  ((struct symbolData*)GetEnvironmentData(theEnv, SYMBOL_DATA))

LOCALE void InitializeAtomTables(void*, struct symbolHashNode**,
                                 struct floatHashNode**,
                                 struct integerHashNode**,
                                 struct bitMapHashNode**,
                                 struct externalAddressHashNode**);
...
LOCALE struct externalAddressHashNode** GetExternalAddressTable(void*);
LOCALE void SetExternalAddressTable(void*, struct externalAddressHashNode**);
LOCALE void RefreshSpecialSymbols(void*);
LOCALE struct symbolMatch* FindSymbolMatches(void*, const char*, unsigned*,
                                             size_t*);
LOCALE void ReturnSymbolMatches(void*, struct symbolMatch*);
LOCALE SYMBOL_HN* GetNextSymbolMatch(void*, const char*, size_t, SYMBOL_HN*,
                                     int, size_t*);
