...
#define PrintUtilityData(theEnv) \
  ((struct printUtilityData*)GetEnvironmentData(theEnv, PRINT_UTILITY_DATA))
...
LOCALE void CantFindItemInFunctionErrorMessage(void*, const char*, const char*,
                                               const char*);
