...
#ifndef DARWIN
#define DARWIN                                                                \
  0 /* Darwin Mac OS 18.6.0, presumably with gcc or Xcode 10.2.1 with Console \
     */
#endif
...
#ifndef UNIX_7
#define UNIX_7 \
  0 /* UNIX System III Version 7 or Sun Unix, presumably with gcc */
#endif
...
#ifndef GENERIC
#if (!UNIX_V) && (!LINUX) && (!UNIX_7) && (!MAC_XCD) && (!DARWIN) && \
    (!WIN_MVC) && (!WIN_GCC) && (!VAX_VMS)
