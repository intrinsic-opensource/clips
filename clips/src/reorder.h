...
LOCALE void CopyLHSParseNode(void*, struct lhsParseNode*, struct lhsParseNode*,
                             int);
...
LOCALE struct lhsParseNode* CombineLHSParseNodes(void*, struct lhsParseNode*,
                                                 struct lhsParseNode*);
// LOCALE void                           AssignPatternMarkedFlag(struct
// lhsParseNode *,short);
