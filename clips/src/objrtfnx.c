...
static void GetPatternObjectAndMarks(void*, int, int, int, INSTANCE_TYPE**,
                                     struct multifieldMarker**);
static void GetObjectValueGeneral(void*, DATA_OBJECT*, INSTANCE_TYPE*,
                                  struct multifieldMarker*,
                                  struct ObjectMatchVar1*);
static void GetObjectValueSimple(void*, DATA_OBJECT*, INSTANCE_TYPE*,
                                 struct ObjectMatchVar2*);
static long CalculateSlotField(struct multifieldMarker*, INSTANCE_SLOT*, long,
                               long*); /* 6.04 Bug Fix */
static void GetInsMultiSlotField(FIELD*, INSTANCE_TYPE*, unsigned, unsigned,
                                 unsigned);
...
globle void InstallObjectPrimitives(void* theEnv) {
  struct entityRecord objectGVInfo1 = {"OBJ_GET_SLOT_JNVAR1",
                                       OBJ_GET_SLOT_JNVAR1,
                                       0,
                                       1,
                                       0,
  ...
  struct entityRecord objectGVInfo2 = {"OBJ_GET_SLOT_JNVAR2",
                                       OBJ_GET_SLOT_JNVAR2,
                                       0,
                                       1,
                                       0,
  ...
  struct entityRecord objectGVPNInfo1 = {"OBJ_GET_SLOT_PNVAR1",
                                         OBJ_GET_SLOT_PNVAR1,
                                         0,
                                         1,
                                         0,
  ...
  struct entityRecord objectGVPNInfo2 = {"OBJ_GET_SLOT_PNVAR2",
                                         OBJ_GET_SLOT_PNVAR2,
                                         0,
                                         1,
                                         0,
  ...
  struct entityRecord objectCmpConstantInfo = {"OBJ_PN_CONSTANT",
                                               OBJ_PN_CONSTANT,
                                               0,
                                               1,
                                               1,
  ...
  struct entityRecord lengthTestInfo = {"OBJ_SLOT_LENGTH",
                                        OBJ_SLOT_LENGTH,
                                        0,
                                        1,
                                        0,
  ...
  struct entityRecord pNSimpleCompareInfo1 = {"OBJ_PN_CMP1",
                                              OBJ_PN_CMP1,
                                              0,
                                              1,
                                              1,
  ...
  struct entityRecord pNSimpleCompareInfo2 = {"OBJ_PN_CMP2",
                                              OBJ_PN_CMP2,
                                              0,
                                              1,
                                              1,
  ...
  struct entityRecord pNSimpleCompareInfo3 = {"OBJ_PN_CMP3",
                                              OBJ_PN_CMP3,
                                              0,
                                              1,
                                              1,
  ...
  struct entityRecord jNSimpleCompareInfo1 = {"OBJ_JN_CMP1",
                                              OBJ_JN_CMP1,
                                              0,
                                              1,
                                              1,
  ...
  struct entityRecord jNSimpleCompareInfo2 = {"OBJ_JN_CMP2",
                                              OBJ_JN_CMP2,
                                              0,
                                              1,
                                              1,
  ...
  struct entityRecord jNSimpleCompareInfo3 = {"OBJ_JN_CMP3",
                                              OBJ_JN_CMP3,
                                              0,
                                              1,
                                              1,
  ...
  AllocateEnvironmentData(theEnv, OBJECT_RETE_DATA,
  ...
  memcpy(&ObjectReteData(theEnv)->ObjectGVPNInfo2, &objectGVPNInfo2,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->ObjectCmpConstantInfo, &objectCmpConstantInfo,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->LengthTestInfo, &lengthTestInfo,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->PNSimpleCompareInfo1, &pNSimpleCompareInfo1,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->PNSimpleCompareInfo2, &pNSimpleCompareInfo2,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->PNSimpleCompareInfo3, &pNSimpleCompareInfo3,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->JNSimpleCompareInfo1, &jNSimpleCompareInfo1,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->JNSimpleCompareInfo2, &jNSimpleCompareInfo2,
         sizeof(struct entityRecord));
  memcpy(&ObjectReteData(theEnv)->JNSimpleCompareInfo3, &jNSimpleCompareInfo3,
         sizeof(struct entityRecord));

  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->ObjectGVInfo1,
                   OBJ_GET_SLOT_JNVAR1);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->ObjectGVInfo2,
                   OBJ_GET_SLOT_JNVAR2);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->ObjectGVPNInfo1,
                   OBJ_GET_SLOT_PNVAR1);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->ObjectGVPNInfo2,
                   OBJ_GET_SLOT_PNVAR2);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->ObjectCmpConstantInfo,
                   OBJ_PN_CONSTANT);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->LengthTestInfo,
                   OBJ_SLOT_LENGTH);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->PNSimpleCompareInfo1,
                   OBJ_PN_CMP1);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->PNSimpleCompareInfo2,
                   OBJ_PN_CMP2);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->PNSimpleCompareInfo3,
                   OBJ_PN_CMP3);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->JNSimpleCompareInfo1,
                   OBJ_JN_CMP1);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->JNSimpleCompareInfo2,
                   OBJ_JN_CMP2);
  InstallPrimitive(theEnv, &ObjectReteData(theEnv)->JNSimpleCompareInfo3,
                   OBJ_JN_CMP3);
}
...
/*****************************************************/
static void DeallocateObjectReteData(void* theEnv) {
...
/****************************************************************/
static void DestroyObjectPatternNetwork(void* theEnv,
...
/************************************************************/
static void DestroyObjectAlphaNodes(void* theEnv, OBJECT_ALPHA_NODE* theNode) {
...
globle intBool ObjectCmpConstantFunction(void* theEnv, void* theValue,
  ...
  if (hack->general) {
    ...
    if (ObjectReteData(theEnv)->CurrentPatternObjectSlot->type == MULTIFIELD) {
      theSegment = (struct multifield*)ObjectReteData(theEnv)
                       ->CurrentPatternObjectSlot->value;
      if (hack->fromBeginning) {
        ...
        theVar.type =
            theSegment
                ->theFields[theSegment->multifieldLength - (hack->offset + 1)]
                .type;
        theVar.value =
            theSegment
                ->theFields[theSegment->multifieldLength - (hack->offset + 1)]
      ...
      theVar.type = (unsigned short)ObjectReteData(theEnv)
                        ->CurrentPatternObjectSlot->type;
...
static void PrintObjectGetVarJN1(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  ...
  if (hack->objectAddress) {
    ...
    EnvPrintRouter(
        theEnv, logicalName,
        ValueToString(FindIDSlotName(theEnv, (unsigned)hack->whichSlot)));
  } else {
...
static intBool ObjectGetVarJNFunction1(void* theEnv, void* theValue,
                                       DATA_OBJECT* theResult) {
  struct ObjectMatchVar1* hack;
  ...
  hack = (struct ObjectMatchVar1*)ValueToBitMap(theValue);
  GetPatternObjectAndMarks(theEnv, ((int)hack->whichPattern), hack->lhs,
                           hack->rhs, &theInstance, &theMarks);
  GetObjectValueGeneral(theEnv, theResult, theInstance, theMarks, hack);
  return (TRUE);
}

static void PrintObjectGetVarJN2(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  ...
  if (hack->fromBeginning) {
    ...
    PrintLongInteger(theEnv, logicalName,
                     (long long)(hack->beginningOffset + 1));
  }
  if (hack->fromEnd) {
...
static intBool ObjectGetVarJNFunction2(void* theEnv, void* theValue,
                                       DATA_OBJECT* theResult) {
  struct ObjectMatchVar2* hack;
  INSTANCE_TYPE* theInstance;
  struct multifieldMarker* theMarks;
...
static void PrintObjectGetVarPN1(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  struct ObjectMatchVar1* hack;
...
static intBool ObjectGetVarPNFunction1(void* theEnv, void* theValue,
                                       DATA_OBJECT* theResult) {
  struct ObjectMatchVar1* hack;

  hack = (struct ObjectMatchVar1*)ValueToBitMap(theValue);
  GetObjectValueGeneral(
      theEnv, theResult, ObjectReteData(theEnv)->CurrentPatternObject,
      ObjectReteData(theEnv)->CurrentPatternObjectMarks, hack);
  return (TRUE);
}

static void PrintObjectGetVarPN2(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  struct ObjectMatchVar2* hack;
...
static intBool ObjectGetVarPNFunction2(void* theEnv, void* theValue,
                                       DATA_OBJECT* theResult) {
  struct ObjectMatchVar2* hack;
...
static void PrintObjectCmpConstant(void* theEnv, const char* logicalName,
                                   void* theValue) {
#if DEVELOPER
  struct ObjectCmpPNConstant* hack;
...
static void PrintSlotLengthTest(void* theEnv, const char* logicalName,
                                void* theValue) {
#if DEVELOPER
...
static intBool SlotLengthTestFunction(void* theEnv, void* theValue,
                                      DATA_OBJECT* theResult) {
  struct ObjectMatchLength* hack;
...
static void PrintPNSimpleCompareFunction1(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
  ...
  EnvPrintRouter(
      theEnv, logicalName,
      ValueToString(FindIDSlotName(theEnv, (unsigned)hack->firstSlot)));
  EnvPrintRouter(theEnv, logicalName, " ");
  EnvPrintRouter(
      theEnv, logicalName,
      ValueToString(FindIDSlotName(theEnv, (unsigned)hack->secondSlot)));
  EnvPrintRouter(theEnv, logicalName, ")");
#else
#if MAC_XCD
#pragma unused(theEnv)
...
static intBool PNSimpleCompareFunction1(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  struct ObjectCmpPNSingleSlotVars1* hack;
  ...
  hack = (struct ObjectCmpPNSingleSlotVars1*)ValueToBitMap(theValue);
  is1 =
      GetInsSlot(ObjectReteData(theEnv)->CurrentPatternObject, hack->firstSlot);
  is2 = GetInsSlot(ObjectReteData(theEnv)->CurrentPatternObject,
                   hack->secondSlot);
...
static void PrintPNSimpleCompareFunction2(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
...
static intBool PNSimpleCompareFunction2(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  struct ObjectCmpPNSingleSlotVars2* hack;
  int rv;
  FIELD f1;
  ...
  GetInsMultiSlotField(&f1, ObjectReteData(theEnv)->CurrentPatternObject,
                       (unsigned)hack->firstSlot, (unsigned)hack->fromBeginning,
                       (unsigned)hack->offset);
  is2 = GetInsSlot(ObjectReteData(theEnv)->CurrentPatternObject,
                   hack->secondSlot);
  if (f1.type != is2->type)
    rv = hack->fail;
...
static void PrintPNSimpleCompareFunction3(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
...
static intBool PNSimpleCompareFunction3(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  struct ObjectCmpPNSingleSlotVars3* hack;
  int rv;
  FIELD f1, f2;
...
static void PrintJNSimpleCompareFunction1(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
...
static intBool JNSimpleCompareFunction1(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  ...
  hack = (struct ObjectCmpJoinSingleSlotVars1*)ValueToBitMap(theValue);
  GetPatternObjectAndMarks(theEnv, ((int)hack->firstPattern),
                           hack->firstPatternLHS, hack->firstPatternRHS, &ins1,
                           &theMarks);
  is1 = GetInsSlot(ins1, hack->firstSlot);
  GetPatternObjectAndMarks(theEnv, ((int)hack->secondPattern),
...
static void PrintJNSimpleCompareFunction2(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
...
static intBool JNSimpleCompareFunction2(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  INSTANCE_TYPE *ins1, *ins2;
  struct multifieldMarker* theMarks;
  struct ObjectCmpJoinSingleSlotVars2* hack;
...
static void PrintJNSimpleCompareFunction3(void* theEnv, const char* logicalName,
                                          void* theValue) {
#if DEVELOPER
...
static intBool JNSimpleCompareFunction3(void* theEnv, void* theValue,
                                        DATA_OBJECT* theResult) {
  INSTANCE_TYPE *ins1, *ins2;
  struct multifieldMarker* theMarks;
  struct ObjectCmpJoinSingleSlotVars3* hack;
...
/****************************************************
  ...
  NOTES        : None
 ****************************************************/
static void GetPatternObjectAndMarks(void* theEnv, int pattern, int lhs,
                                     int rhs, INSTANCE_TYPE** theInstance,
                                     struct multifieldMarker** theMarkers) {
  if (lhs) {
    *theInstance = (INSTANCE_TYPE*)get_nth_pm_match(
                       EngineData(theEnv)->GlobalLHSBinds, pattern)
                       ->matchingItem;
    *theMarkers =
        get_nth_pm_match(EngineData(theEnv)->GlobalLHSBinds, pattern)->markers;
  } else if (rhs) {
    *theInstance = (INSTANCE_TYPE*)get_nth_pm_match(
                       EngineData(theEnv)->GlobalRHSBinds, pattern)
                       ->matchingItem;
    *theMarkers =
    ...
    *theInstance =
        (INSTANCE_TYPE*)get_nth_pm_match(EngineData(theEnv)->GlobalRHSBinds, 0)
            ->matchingItem;
    *theMarkers =
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static void GetObjectValueGeneral(void* theEnv, DATA_OBJECT* result,
                                  INSTANCE_TYPE* theInstance,
                                  struct multifieldMarker* theMarks,
  ...
  insSlot =
      &theInstance
           ->slotAddresses[theInstance->cls->slotNameMap[matchVar->whichSlot] -
                           1];
  ...
  if ((theInstance->basisSlots != NULL) &&
    ...
    if (basisSlot->value != NULL) insSlot = &basisSlot;
  }
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static void GetObjectValueSimple(void* theEnv, DATA_OBJECT* result,
                                 INSTANCE_TYPE* theInstance,
...
/****************************************************
  ...
  NOTES        : None
 ****************************************************/
static long CalculateSlotField(struct multifieldMarker* theMarkers,
                               INSTANCE_SLOT* theSlot, long theIndex,
                               long* extent) {
  long actualIndex;
  void* theSlotName;
  ...
  *extent = -1;
  ...
  while (theMarkers != NULL) {
    if (theMarkers->where.whichSlot == theSlotName) break;
    theMarkers = theMarkers->next;
  }
  while ((theMarkers != NULL) ? (theMarkers->where.whichSlot == theSlotName)
                              : FALSE) {
...
/****************************************************
  ...
  NOTES        : Should only be used to access
                 ...
                 comparisons
 ****************************************************/
static void GetInsMultiSlotField(FIELD* theField, INSTANCE_TYPE* theInstance,
                                 unsigned theSlotID, unsigned fromBeginning,
                                 unsigned offset) {
  ...
  insSlot =
      theInstance->slotAddresses[theInstance->cls->slotNameMap[theSlotID] - 1];
  ...
  if (insSlot->desc->multiple) {
    ...
    if (fromBeginning)
      ...
      tmpField =
          &theSegment->theFields[theSegment->multifieldLength - offset - 1];
