...
#define UtilityData(theEnv) \
  ((struct utilityData*)GetEnvironmentData(theEnv, UTILITY_DATA))

/* Is c the start of a utf8 sequence? */
#define IsUTF8Start(ch) (((ch) & 0xC0) != 0x80)
#define IsUTF8MultiByteStart(ch) \
  ((((unsigned char)ch) >= 0xC0) && (((unsigned char)ch) <= 0xF7))
#define IsUTF8MultiByteContinuation(ch) \
  ((((unsigned char)ch) >= 0x80) && (((unsigned char)ch) <= 0xBF))
...
LOCALE char* InsertInString(void*, const char*, size_t, char*, size_t*,
                            size_t*);
LOCALE char* AppendNToString(void*, const char*, char*, size_t, size_t*,
                             size_t*);
...
LOCALE struct callFunctionItem* AddFunctionToCallList(void*, const char*, int,
                                                      void (*)(void*),
                                                      struct callFunctionItem*,
                                                      intBool);
LOCALE struct callFunctionItem* AddFunctionToCallListWithContext(
    void*, const char*, int, void (*)(void*), struct callFunctionItem*, intBool,
    void*);
LOCALE struct callFunctionItem* RemoveFunctionFromCallList(
    void*, const char*, struct callFunctionItem*, int*);
LOCALE void DeallocateCallList(void*, struct callFunctionItem*);
LOCALE struct callFunctionItemWithArg* AddFunctionToCallListWithArg(
    void*, const char*, int, void (*)(void*, void*),
    struct callFunctionItemWithArg*, intBool);
LOCALE struct callFunctionItemWithArg* AddFunctionToCallListWithArgWithContext(
    void*, const char*, int, void (*)(void*, void*),
    struct callFunctionItemWithArg*, intBool, void*);
LOCALE struct callFunctionItemWithArg* RemoveFunctionFromCallListWithArg(
    void*, const char*, struct callFunctionItemWithArg*, int*);
...
LOCALE void RestorePriorGarbageFrame(void*, struct garbageFrame*,
                                     struct garbageFrame*, struct dataObject*);
