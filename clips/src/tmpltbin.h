...
#define DeftemplateBinaryData(theEnv) \
  ((struct deftemplateBinaryData*)GetEnvironmentData(theEnv, TMPLTBIN_DATA))

#define DeftemplatePointer(i) \
  ((struct deftemplate*)(&DeftemplateBinaryData(theEnv)->DeftemplateArray[i]))
