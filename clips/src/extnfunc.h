...
#define ValueFunctionType(target) \
  (((struct FunctionDefinition*)target)->returnValueType)
#define ExpressionFunctionType(target) \
  (((struct FunctionDefinition*)((target)->value))->returnValueType)
#define ExpressionFunctionPointer(target) \
  (((struct FunctionDefinition*)((target)->value))->functionPointer)
#define ExpressionFunctionCallName(target) \
  (((struct FunctionDefinition*)((target)->value))->callFunctionName)
#define ExpressionFunctionRealName(target) \
  (((struct FunctionDefinition*)((target)->value))->actualFunctionName)
...
#define ExternalFunctionData(theEnv)                        \
  ((struct externalFunctionData*)GetEnvironmentData(theEnv, \
...
LOCALE int EnvDefineFunction(void*, const char*, int, int (*)(void*),
                             const char*);
LOCALE int EnvDefineFunction2(void*, const char*, int, int (*)(void*),
                              const char*, const char*);
LOCALE int EnvDefineFunctionWithContext(void*, const char*, int, int (*)(void*),
                                        const char*, void*);
LOCALE int EnvDefineFunction2WithContext(void*, const char*, int,
                                         int (*)(void*), const char*,
                                         const char*, void*);
LOCALE int DefineFunction3(void*, const char*, int, int (*)(void*), const char*,
                           const char*, intBool, void*);
LOCALE int AddFunctionParser(void*, const char*,
                             struct expr* (*)(void*, struct expr*,
                                              const char*));
...
LOCALE int DefineFunction2(const char*, int, int (*)(void), const char*,
                           const char*);
#endif /* (! RUN_TIME) */
