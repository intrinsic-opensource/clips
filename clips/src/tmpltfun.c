...
static SYMBOL_HN* CheckDeftemplateAndSlotArguments(void*, const char*,
                                                   struct deftemplate**, int);

#if (!RUN_TIME) && (!BLOAD_ONLY)
static struct expr* ModAndDupParse(void*, struct expr*, const char*,
                                   const char*);
...
#if !RUN_TIME
  EnvDefineFunction(theEnv, "modify", 'u', PTIEF ModifyCommand,
                    "ModifyCommand");
  EnvDefineFunction(theEnv, "duplicate", 'u', PTIEF DuplicateCommand,
                    "DuplicateCommand");

  EnvDefineFunction2(theEnv, "deftemplate-slot-names", 'u',
                     PTIEF DeftemplateSlotNamesFunction,
                     "DeftemplateSlotNamesFunction", "11z");
  EnvDefineFunction2(theEnv, "deftemplate-slot-default-value", 'u',
                     PTIEF DeftemplateSlotDefaultValueFunction,
                     "DeftemplateSlotDefaultValueFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-cardinality", 'u',
                     PTIEF DeftemplateSlotCardinalityFunction,
                     "DeftemplateSlotCardinalityFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-allowed-values", 'u',
                     PTIEF DeftemplateSlotAllowedValuesFunction,
                     "DeftemplateSlotAllowedValuesFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-range", 'u',
                     PTIEF DeftemplateSlotRangeFunction,
                     "DeftemplateSlotRangeFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-types", 'u',
                     PTIEF DeftemplateSlotTypesFunction,
                     "DeftemplateSlotTypesFunction", "22w");

  EnvDefineFunction2(theEnv, "deftemplate-slot-multip", 'b',
                     PTIEF DeftemplateSlotMultiPFunction,
                     "DeftemplateSlotMultiPFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-singlep", 'b',
                     PTIEF DeftemplateSlotSinglePFunction,
                     "DeftemplateSlotSinglePFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-existp", 'b',
                     PTIEF DeftemplateSlotExistPFunction,
                     "DeftemplateSlotExistPFunction", "22w");
  EnvDefineFunction2(theEnv, "deftemplate-slot-defaultp", 'w',
                     PTIEF DeftemplateSlotDefaultPFunction,
                     "DeftemplateSlotDefaultPFunction", "22w");

  EnvDefineFunction2(theEnv, "deftemplate-slot-facet-existp", 'b',
                     PTIEF DeftemplateSlotFacetExistPFunction,
                     "DeftemplateSlotFacetExistPFunction", "33w");

  EnvDefineFunction2(theEnv, "deftemplate-slot-facet-value", 'u',
                     PTIEF DeftemplateSlotFacetValueFunction,
...
/***************************************************************/
static void DuplicateModifyCommand(void* theEnv, int retractIt,
  ...
  newFact = (struct fact*)CreateFactBySize(
      theEnv, oldFact->theProposition.multifieldLength);
  newFact->whichDeftemplate = templatePtr;
  for (i = 0; i < (int)oldFact->theProposition.multifieldLength; i++) {
    newFact->theProposition.theFields[i].type =
        oldFact->theProposition.theFields[i].type;
    if (newFact->theProposition.theFields[i].type != MULTIFIELD) {
      newFact->theProposition.theFields[i].value =
          oldFact->theProposition.theFields[i].value;
    } else {
  ...
  while (testPtr != NULL) {
    ...
    if (newFact->theProposition.theFields[position].type != MULTIFIELD) {
      ...
      if ((testPtr->argList == NULL) ? TRUE
                                     : (testPtr->argList->nextArg != NULL)) {
        MultiIntoSingleFieldSlotError(theEnv, GetNthSlot(templatePtr, position),
                                      templatePtr);
        ReturnFact(theEnv, newFact);
        return;
      }
  ...
  for (i = 0; i < (int)oldFact->theProposition.multifieldLength; i++) {
    ...
    {
      newFact->theProposition.theFields[i].value = CopyMultifield(
          theEnv,
          (struct multifield*)oldFact->theProposition.theFields[i].value);
    }
  }
  ...
  if (retractIt && (FactData(theEnv)->ListOfModifyFunctions != NULL)) {
    ...
    if (replacement != NULL) {
      ...
      replacement->factHeader.timeTag =
    ...
    for (theModifyFunction = FactData(theEnv)->ListOfModifyFunctions;
      ...
      if (theModifyFunction->environmentAware) {
        ((void (*)(void*, void*, void*))(*theModifyFunction->func))(
            theEnv, oldFact, replacement);
      } else {
        ((void (*)(void*, void*))(*theModifyFunction->func))(oldFact,
                                                             replacement);
      }
    }
  }
...
globle void DeftemplateSlotNamesFunction(void* theEnv,
  ...
  if (EnvArgCountCheck(theEnv, "deftemplate-slot-names", EXACTLY, 1) == -1)
    return;
  ...
  deftemplateName =
      GetConstructName(theEnv, "deftemplate-slot-names", "deftemplate name");
  if (deftemplateName == NULL) return;

  theDeftemplate =
      (struct deftemplate*)EnvFindDeftemplate(theEnv, deftemplateName);
...
/*   for the deftemplate-slot-names function. */
/**********************************************/
globle void EnvDeftemplateSlotNames(void* theEnv, void* vTheDeftemplate,
                                    DATA_OBJECT* returnValue) {
  ...
  for (count = 0, theSlot = theDeftemplate->slotList; theSlot != NULL;
  ...
  for (count = 1, theSlot = theDeftemplate->slotList; theSlot != NULL;
...
globle void* DeftemplateSlotDefaultPFunction(void* theEnv) {
  ...
  slotName = CheckDeftemplateAndSlotArguments(theEnv, "deftemplate-slot-existp",
                                              &theDeftemplate, 2);
  if (slotName == NULL) {
  ...
  defaultType = EnvDeftemplateSlotDefaultP(theEnv, theDeftemplate,
                                           ValueToString(slotName));
...
/*   for the deftemplate-slot-defaultp function. */
/*************************************************/
globle int EnvDeftemplateSlotDefaultP(void* theEnv, void* vTheDeftemplate,
                                      const char* slotName) {
  short position;
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  struct templateSlot* theSlot;
  ...
  if (theDeftemplate->implied) {
    if (strcmp(slotName, "implied") == 0) {
      ...
      InvalidDeftemplateSlotMessage(
          theEnv, slotName, ValueToString(theDeftemplate->header.name), FALSE);
      return (NO_DEFAULT);
    }
  }
  ...
  else if ((theSlot = FindSlot(theDeftemplate,
                               (SYMBOL_HN*)EnvAddSymbol(theEnv, slotName),
                               &position)) == NULL) {
    SetEvaluationError(theEnv, TRUE);
    InvalidDeftemplateSlotMessage(
        theEnv, slotName, ValueToString(theDeftemplate->header.name), FALSE);
...
globle void DeftemplateSlotDefaultValueFunction(void* theEnv,
  ...
  slotName = CheckDeftemplateAndSlotArguments(
      theEnv, "deftemplate-slot-default-value", &theDeftemplate, 2);
  if (slotName == NULL) {
  ...
  EnvDeftemplateSlotDefaultValue(theEnv, theDeftemplate,
                                 ValueToString(slotName), theValue);
}
...
globle intBool EnvDeftemplateSlotDefaultValue(void* theEnv,
  ...
  } else if (DeftemplateSlotDefault(theEnv, theDeftemplate, theSlot, &tempDO,
                                    TRUE)) {
...
globle void DeftemplateSlotCardinalityFunction(void* theEnv,
  ...
  slotName = CheckDeftemplateAndSlotArguments(
      theEnv, "deftemplate-slot-cardinality", &theDeftemplate, 2);
  if (slotName == NULL) {
  ...
  EnvDeftemplateSlotCardinality(theEnv, theDeftemplate, ValueToString(slotName),
                                theValue);
}
...
/*   for the deftemplate-slot-cardinality function. */
/****************************************************/
globle void EnvDeftemplateSlotCardinality(void* theEnv, void* vTheDeftemplate,
                                          const char* slotName,
                                          DATA_OBJECT* result) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
...
globle void DeftemplateSlotAllowedValuesFunction(void* theEnv,
  ...
  slotName = CheckDeftemplateAndSlotArguments(
      theEnv, "deftemplate-slot-allowed-values", &theDeftemplate, 2);
  if (slotName == NULL) {
    EnvSetMultifieldErrorValue(theEnv, theValue);
    return;
  }
  ...
  EnvDeftemplateSlotAllowedValues(theEnv, theDeftemplate,
                                  ValueToString(slotName), theValue);
}
...
/*   for the deftemplate-slot-allowed-values function. */
/*******************************************************/
globle void EnvDeftemplateSlotAllowedValues(void* theEnv, void* vTheDeftemplate,
                                            const char* slotName,
                                            DATA_OBJECT* result) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  ...
  if ((theSlot->constraints != NULL)
          ? (theSlot->constraints->restrictionList == NULL)
          : TRUE) {
    result->type = SYMBOL;
    result->value = EnvFalseSymbol(theEnv);
    return;
...
globle void DeftemplateSlotRangeFunction(void* theEnv,
  ...
  slotName = CheckDeftemplateAndSlotArguments(theEnv, "deftemplate-slot-range",
                                              &theDeftemplate, 2);
  if (slotName == NULL) {
    EnvSetMultifieldErrorValue(theEnv, theValue);
    return;
  ...
  EnvDeftemplateSlotRange(theEnv, theDeftemplate, ValueToString(slotName),
                          theValue);
}
...
/*   for the deftemplate-slot-range function. */
/**********************************************/
globle void EnvDeftemplateSlotRange(void* theEnv, void* vTheDeftemplate,
                                    const char* slotName, DATA_OBJECT* result) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  struct templateSlot* theSlot;
  ...
  if ((theSlot->constraints == NULL)
          ? FALSE
          : (theSlot->constraints->anyAllowed ||
...
globle void DeftemplateSlotTypesFunction(void* theEnv,
  ...
  slotName = CheckDeftemplateAndSlotArguments(theEnv, "deftemplate-slot-types",
                                              &theDeftemplate, 2);
  if (slotName == NULL) {
    EnvSetMultifieldErrorValue(theEnv, theValue);
    return;
  ...
  EnvDeftemplateSlotTypes(theEnv, theDeftemplate, ValueToString(slotName),
                          theValue);
}
...
/*   for the deftemplate-slot-types function. */
/**********************************************/
globle void EnvDeftemplateSlotTypes(void* theEnv, void* vTheDeftemplate,
                                    const char* slotName, DATA_OBJECT* result) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  ...
  if ((theDeftemplate->implied) ||
      ((theSlot->constraints != NULL) ? theSlot->constraints->anyAllowed
                                      : TRUE)) {
#if OBJECT_SYSTEM
    numTypes = 8;
#else
...
globle int DeftemplateSlotMultiPFunction(void* theEnv) {
  ...
  slotName = CheckDeftemplateAndSlotArguments(theEnv, "deftemplate-slot-multip",
                                              &theDeftemplate, 2);
  if (slotName == NULL) {
    return (FALSE);
  }
  ...
  return EnvDeftemplateSlotMultiP(theEnv, theDeftemplate,
                                  ValueToString(slotName));
}
...
/*   for the deftemplate-slot-multip function. */
/***********************************************/
globle int EnvDeftemplateSlotMultiP(void* theEnv, void* vTheDeftemplate,
                                    const char* slotName) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  struct templateSlot* theSlot;
...
globle int DeftemplateSlotSinglePFunction(void* theEnv) {
  ...
  slotName = CheckDeftemplateAndSlotArguments(
      theEnv, "deftemplate-slot-singlep", &theDeftemplate, 2);
  if (slotName == NULL) {
    return (FALSE);
  }
  ...
  return EnvDeftemplateSlotSingleP(theEnv, theDeftemplate,
                                   ValueToString(slotName));
}
...
/*   for the deftemplate-slot-singlep function. */
/************************************************/
globle int EnvDeftemplateSlotSingleP(void* theEnv, void* vTheDeftemplate,
                                     const char* slotName) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  struct templateSlot* theSlot;
...
globle int DeftemplateSlotExistPFunction(void* theEnv) {
  ...
  return EnvDeftemplateSlotExistP(theEnv, theDeftemplate,
                                  ValueToString(slotName));
}
...
/*   for the deftemplate-slot-existp function. */
/************************************************/
globle int EnvDeftemplateSlotExistP(void* theEnv, void* vTheDeftemplate,
                                    const char* slotName) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
  short position;
  ...
  else if (FindSlot(theDeftemplate, (SYMBOL_HN*)EnvAddSymbol(theEnv, slotName),
                    &position) == NULL) {
    return (FALSE);
  }
...
globle int DeftemplateSlotFacetExistPFunction(void* theEnv) {
  ...
  slotName = CheckDeftemplateAndSlotArguments(
      theEnv, "deftemplate-slot-facet-existp", &theDeftemplate, 3);
  if (slotName == NULL) {
    return (FALSE);
  }
  ...
  if (EnvArgTypeCheck(theEnv, "deftemplate-slot-facet-existp", 3, SYMBOL,
                      &facetName) == FALSE) {
    return (FALSE);
  }
  ...
  return EnvDeftemplateSlotFacetExistP(
      theEnv, theDeftemplate, ValueToString(slotName), DOToString(facetName));
}
...
/*   for the deftemplate-slot-facet-existp function. */
/*****************************************************/
globle int EnvDeftemplateSlotFacetExistP(void* theEnv, void* vTheDeftemplate,
                                         const char* slotName,
  ...
  for (tempFacet = theSlot->facetList; tempFacet != NULL;
...
globle void DeftemplateSlotFacetValueFunction(void* theEnv,
  ...
  EnvDeftemplateSlotFacetValue(theEnv, theDeftemplate, ValueToString(slotName),
                               DOToString(facetName), returnValue);
}
...
/*   for the deftemplate-slot-facet-value function. */
/****************************************************/
globle int EnvDeftemplateSlotFacetValue(void* theEnv, void* vTheDeftemplate,
                                        const char* slotName,
                                        const char* facetName,
                                        DATA_OBJECT* rv) {
  struct deftemplate* theDeftemplate = (struct deftemplate*)vTheDeftemplate;
...
/***************************************************************/
globle intBool UpdateModifyDuplicate(void* theEnv, struct expr* top,
                                     const char* name, void* vTheLHS) {
  ...
  theDeftemplate = (struct deftemplate*)LookupConstruct(
      theEnv, DeftemplateData(theEnv)->DeftemplateConstruct,
      ValueToString(templateName), FALSE);
  ...
  while (tempArg != NULL) {
    ...
    if ((slotPtr = FindSlot(theDeftemplate, (SYMBOL_HN*)tempArg->value,
                            &position)) == NULL) {
      ...
      if (tempArg->argList == NULL) {
        ...
        return (FALSE);
                 ...
                 ((tempArg->argList->type == FCALL)
                      ? (((struct FunctionDefinition*)tempArg->argList->value)
                             ->returnValueType == 'm')
                      : FALSE)) {
        SingleFieldSlotCardinalityError(theEnv, slotPtr->slotName->contents);
        return (FALSE);
    ...
    tempArg->value = (void*)EnvAddLong(
        theEnv, (long long)(FindSlotPosition(theDeftemplate,
                                             (SYMBOL_HN*)tempArg->value) -
                            1));
...
/**************************************************/
static SYMBOL_HN* FindTemplateForFactAddress(SYMBOL_HN* factAddress,
  ...
  if ((thePattern->type != SYMBOL) || (thePattern->right != NULL) ||
...
/*******************************************/
globle struct expr* ModifyParse(void* theEnv, struct expr* top,
...
/*************************************************/
globle struct expr* DuplicateParse(void* theEnv, struct expr* top,
                                   const char* logicalName) {
...
/*************************************************************/
static struct expr* ModAndDupParse(void* theEnv, struct expr* top,
  ...
  while (theToken.type != RPAREN) {
    ...
    for (tempSlot = top->argList->nextArg; tempSlot != NULL;
         tempSlot = tempSlot->nextArg) {
      if (tempSlot->value == theToken.value) {
        AlreadyParsedErrorMessage(theEnv, "slot ",
                                  ValueToString(theToken.value));
        ReturnExpression(theEnv, top);
        return (NULL);
      }
    }
...
globle void DeftemplateSlotNames(void* vTheDeftemplate,
                                 DATA_OBJECT* returnValue) {
  EnvDeftemplateSlotNames(GetCurrentEnvironment(), vTheDeftemplate,
                          returnValue);
}

globle intBool DeftemplateSlotDefaultValue(void* vTheDeftemplate,
                                           const char* slotName,
                                           DATA_OBJECT_PTR theValue) {
  return EnvDeftemplateSlotDefaultValue(GetCurrentEnvironment(),
                                        vTheDeftemplate, slotName, theValue);
}

globle void DeftemplateSlotCardinality(void* vTheDeftemplate,
                                       const char* slotName,
                                       DATA_OBJECT* result) {
  EnvDeftemplateSlotCardinality(GetCurrentEnvironment(), vTheDeftemplate,
                                slotName, result);
}

globle void DeftemplateSlotAllowedValues(void* vTheDeftemplate,
                                         const char* slotName,
                                         DATA_OBJECT* result) {
  EnvDeftemplateSlotAllowedValues(GetCurrentEnvironment(), vTheDeftemplate,
                                  slotName, result);
}

globle void DeftemplateSlotRange(void* vTheDeftemplate, const char* slotName,
                                 DATA_OBJECT* result) {
  EnvDeftemplateSlotRange(GetCurrentEnvironment(), vTheDeftemplate, slotName,
                          result);
}

globle void DeftemplateSlotTypes(void* vTheDeftemplate, const char* slotName,
                                 DATA_OBJECT* result) {
  EnvDeftemplateSlotTypes(GetCurrentEnvironment(), vTheDeftemplate, slotName,
                          result);
}

globle int DeftemplateSlotMultiP(void* vTheDeftemplate, const char* slotName) {
  return EnvDeftemplateSlotMultiP(GetCurrentEnvironment(), vTheDeftemplate,
                                  slotName);
}

globle int DeftemplateSlotSingleP(void* vTheDeftemplate, const char* slotName) {
  return EnvDeftemplateSlotSingleP(GetCurrentEnvironment(), vTheDeftemplate,
                                   slotName);
}

globle int DeftemplateSlotExistP(void* vTheDeftemplate, const char* slotName) {
  return EnvDeftemplateSlotExistP(GetCurrentEnvironment(), vTheDeftemplate,
                                  slotName);
}

globle int DeftemplateSlotDefaultP(void* vTheDeftemplate,
                                   const char* slotName) {
  return EnvDeftemplateSlotDefaultP(GetCurrentEnvironment(), vTheDeftemplate,
                                    slotName);
}
