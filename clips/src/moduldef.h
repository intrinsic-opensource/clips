...
#define DefmoduleData(theEnv) \
  ((struct defmoduleData*)GetEnvironmentData(theEnv, DEFMODULE_DATA))
...
LOCALE int RegisterModuleItem(void*, const char*, void* (*)(void*),
...
LOCALE void AddAfterModuleChangeFunction(void*, const char*, void (*)(void*),
                                         int);
