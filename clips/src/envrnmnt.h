...
#define GetEnvironmentData(theEnv, position) \
  (((struct environmentData*)theEnv)->theData[position])
#define SetEnvironmentData(theEnv, position, value) \
  (((struct environmentData*)theEnv)->theData[position] = value)

LOCALE intBool AllocateEnvironmentData(void*, unsigned int, unsigned long,
                                       void (*)(void*));
...
LOCALE intBool AddEnvironmentCleanupFunction(void*, const char*,
                                             void (*)(void*), int);
