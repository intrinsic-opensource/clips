...
/***************************************/
globle void PrintFactJNCompVars1(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
...
/***************************************/
globle void PrintFactJNCompVars2(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
...
/***************************************/
globle void PrintFactPNCompVars1(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  ...
  if (hack->pass)
    ...
    EnvPrintRouter(theEnv, logicalName, "n ");
...
/**************************************/
globle void PrintFactSlotLength(void* theEnv, const char* logicalName,
                                void* theValue) {
#if DEVELOPER
...
/*************************************/
globle void PrintFactJNGetVar1(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
  ...
  if (hack->factAddress)
    EnvPrintRouter(theEnv, logicalName, "t ");
  else
    EnvPrintRouter(theEnv, logicalName, "f ");
  if (hack->allFields)
    EnvPrintRouter(theEnv, logicalName, "t ");
...
/*************************************/
globle void PrintFactJNGetVar2(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
...
/*************************************/
globle void PrintFactJNGetVar3(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
...
/*************************************/
globle void PrintFactPNGetVar1(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
  ...
  if (hack->factAddress)
    ...
    EnvPrintRouter(theEnv, logicalName, "f ");
  if (hack->allFields)
    EnvPrintRouter(theEnv, logicalName, "t F");
  else
    EnvPrintRouter(theEnv, logicalName, "f F");
...
/*************************************/
globle void PrintFactPNGetVar2(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
...
/*************************************/
globle void PrintFactPNGetVar3(void* theEnv, const char* logicalName,
                               void* theValue) {
#if DEVELOPER
  ...
  if (hack->fromBeginning)
    ...
    EnvPrintRouter(theEnv, logicalName, "f ");
  if (hack->fromEnd)
    EnvPrintRouter(theEnv, logicalName, "t B");
  else
    EnvPrintRouter(theEnv, logicalName, "f B");
...
/***************************************/
globle void PrintFactPNConstant1(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
  ...
  PrintAtom(theEnv, logicalName, GetFirstArgument()->type,
...
/***************************************/
globle void PrintFactPNConstant2(void* theEnv, const char* logicalName,
                                 void* theValue) {
#if DEVELOPER
