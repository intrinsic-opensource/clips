...
void PPDrive(void*, struct partialMatch*, struct partialMatch*,
             struct joinNode*, int);
unsigned long BetaMemoryHashValue(void*, struct expr*, struct partialMatch*,
                                  struct partialMatch*, struct joinNode*);
intBool EvaluateSecondaryNetworkTest(void*, struct partialMatch*,
                                     struct joinNode*);
