...
#define InstanceFileData(theEnv) \
  ((struct instanceFileData*)GetEnvironmentData(theEnv, INSTANCE_FILE_DATA))
...
LOCALE long EnvSaveInstancesDriver(void*, const char*, int, EXPRESSION*,
                                   intBool);
LOCALE long EnvSaveInstances(void*, const char*, int);
#if BSAVE_INSTANCES
LOCALE long BinarySaveInstancesCommand(void*);
LOCALE long EnvBinarySaveInstancesDriver(void*, const char*, int, EXPRESSION*,
                                         intBool);
