...
struct constructData {
  ...
  size_t MaxWrnChars;
  size_t CurWrnPos;
  void (*ParserErrorCallback)(void*, const char*, const char*, const char*,
                              long);
#endif
...
#define ConstructData(theEnv) \
  ((struct constructData*)GetEnvironmentData(theEnv, CONSTRUCT_DATA))
...
LOCALE intBool AddSaveFunction(void*, const char*,
...
LOCALE struct construct* AddConstruct(
    void*, const char*, const char*, int (*)(void*, const char*),
    void* (*)(void*, const char*), SYMBOL_HN* (*)(struct constructHeader*),
    ...
    intBool (*)(void*, void*), int (*)(void*, void*), void (*)(void*, void*));
...
LOCALE void (*EnvSetParserErrorCallback(
