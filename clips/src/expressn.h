...
#define EnvSetpType(theEnv, target, val) \
  ((target)->type = (unsigned short)(val))
...
#define ExpressionData(theEnv) \
  ((struct expressionData*)GetEnvironmentData(theEnv, EXPRESSION_DATA))
