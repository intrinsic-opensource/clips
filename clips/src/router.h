...
#define RouterData(theEnv) \
  ((struct routerData*)GetEnvironmentData(theEnv, ROUTER_DATA))
...
LOCALE intBool EnvAddRouterWithContext(void*, const char*, int,
                                       int (*)(void*, const char*),
                                       int (*)(void*, const char*, const char*),
                                       int (*)(void*, const char*),
                                       int (*)(void*, int, const char*),
                                       int (*)(void*, int), void*);
LOCALE intBool EnvAddRouter(void*, const char*, int,
                            int (*)(void*, const char*),
                            int (*)(void*, const char*, const char*),
                            int (*)(void*, const char*),
                            int (*)(void*, int, const char*),
...
LOCALE intBool AddRouter(const char*, int, int (*)(const char*),
