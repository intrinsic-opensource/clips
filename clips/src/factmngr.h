...
#define FactData(theEnv) \
  ((struct factsData*)GetEnvironmentData(theEnv, FACTS_DATA))
...
LOCALE intBool EnvAddAssertFunction(void*, const char*, void (*)(void*, void*),
                                    int);
LOCALE intBool EnvAddAssertFunctionWithContext(void*, const char*,
                                               void (*)(void*, void*), int,
                                               void*);
LOCALE intBool EnvRemoveAssertFunction(void*, const char*);
LOCALE intBool EnvAddRetractFunction(void*, const char*, void (*)(void*, void*),
                                     int);
...
LOCALE intBool AddModifyFunction(const char*, void (*)(void*, void*, void*),
                                 int);
