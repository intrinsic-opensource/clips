...
#define MessageHandlerData(theEnv) \
  ((struct messageHandlerData*)GetEnvironmentData(theEnv, MESSAGE_HANDLER_DATA))
...
#endif
LOCALE unsigned EnvFindDefmessageHandler(void*, void*, const char*,
                                         const char*);
...
LOCALE long DisplayHandlersInLinks(void*, const char*, PACKED_CLASS_LINKS*,
                                   int);
#endif
