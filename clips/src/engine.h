...
#define EngineData(theEnv) \
  ((struct engineData*)GetEnvironmentData(theEnv, ENGINE_DATA))
...
LOCALE intBool EnvAddRunFunction(void*, const char*, void (*)(void*), int);
LOCALE intBool EnvAddRunFunctionWithContext(void*, const char*, void (*)(void*),
                                            int, void*);
