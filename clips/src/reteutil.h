...
LOCALE struct partialMatch* MergePartialMatches(void*, struct partialMatch*,
                                                struct partialMatch*);
LOCALE long int IncrementPseudoFactIndex(void);
LOCALE struct partialMatch* GetAlphaMemory(void*, struct patternNodeHeader*,
                                           unsigned long);
...
LOCALE void RemoveAlphaMemoryMatches(void*, struct patternNodeHeader*,
...
LOCALE struct partialMatch* CreateAlphaMatch(void*, void*,
                                             struct multifieldMarker*,
...
LOCALE void UpdateBetaPMLinks(void*, struct partialMatch*, struct partialMatch*,
                              struct partialMatch*, struct joinNode*,
                              unsigned long, int);
LOCALE void UnlinkBetaPMFromNodeAndLineage(void*, struct joinNode*,
                                           struct partialMatch*, int);
LOCALE void UnlinkNonLeftLineage(void*, struct joinNode*, struct partialMatch*,
                                 int);
...
LOCALE unsigned long PrintBetaMemory(void*, const char*, struct betaMemory*,
                                     int, const char*, int);
