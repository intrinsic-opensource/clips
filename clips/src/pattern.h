...
struct patternParser {
  ...
  struct expr* (*genCompareJNValuesFunction)(void*, struct lhsParseNode*,
  ...
  struct expr* (*genComparePNValuesFunction)(void*, struct lhsParseNode*,
                                             struct lhsParseNode*);
...
#define PatternData(theEnv) \
  ((struct patternData*)GetEnvironmentData(theEnv, PATTERN_DATA))
...
LOCALE void GetNextPatternEntity(void*, struct patternParser**,
                                 struct patternEntity**);
LOCALE struct patternParser* GetPatternParser(void*, int);
LOCALE struct lhsParseNode* RestrictionParse(void*, const char*, struct token*,
                                             int, struct symbolHashNode*, short,
                                             struct constraintRecord*, short);
LOCALE int PostPatternAnalysis(void*, struct lhsParseNode*);
LOCALE void PatternNodeHeaderToCode(void*, FILE*, struct patternNodeHeader*,
                                    int, int);
...
LOCALE intBool RemoveHashedPatternNode(void*, void*, void*, unsigned short,
                                       void*);
