...
#define MultiFunctionData(theEnv) \
  ((struct multiFunctionData*)GetEnvironmentData(theEnv, MULTIFUN_DATA))
...
globle void MultifieldFunctionDefinitions(void* theEnv) {
  AllocateEnvironmentData(theEnv, MULTIFUN_DATA,
                          sizeof(struct multiFunctionData), NULL);

#if !RUN_TIME
  EnvDefineFunction2(theEnv, "first$", 'm', PTIEF FirstFunction,
                     "FirstFunction", "11m");
  EnvDefineFunction2(theEnv, "rest$", 'm', PTIEF RestFunction, "RestFunction",
                     "11m");
  EnvDefineFunction2(theEnv, "subseq$", 'm', PTIEF SubseqFunction,
                     "SubseqFunction", "33im");
  EnvDefineFunction2(theEnv, "delete-member$", 'm', PTIEF DeleteMemberFunction,
                     "DeleteMemberFunction", "2*um");
  EnvDefineFunction2(theEnv, "replace-member$", 'm',
                     PTIEF ReplaceMemberFunction, "ReplaceMemberFunction",
                     "3*um");
  EnvDefineFunction2(theEnv, "delete$", 'm', PTIEF DeleteFunction,
                     "DeleteFunction", "33im");
  EnvDefineFunction2(theEnv, "replace$", 'm', PTIEF ReplaceFunction,
                     "ReplaceFunction", "4**mii");
  EnvDefineFunction2(theEnv, "insert$", 'm', PTIEF InsertFunction,
                     "InsertFunction", "3**mi");
  EnvDefineFunction2(theEnv, "explode$", 'm', PTIEF ExplodeFunction,
                     "ExplodeFunction", "11s");
  EnvDefineFunction2(theEnv, "implode$", 's', PTIEF ImplodeFunction,
                     "ImplodeFunction", "11m");
  EnvDefineFunction2(theEnv, "nth$", 'u', PTIEF NthFunction, "NthFunction",
                     "22*im");
  EnvDefineFunction2(theEnv, "member$", 'u', PTIEF MemberFunction,
                     "MemberFunction", "22*um");
  EnvDefineFunction2(theEnv, "subsetp", 'b', PTIEF SubsetpFunction,
                     "SubsetpFunction", "22*mm");
  EnvDefineFunction2(theEnv, "progn$", 'u', PTIEF MultifieldPrognFunction,
                     "MultifieldPrognFunction", NULL);
  EnvDefineFunction2(theEnv, "foreach", 'u', PTIEF ForeachFunction,
                     "ForeachFunction", NULL);
  EnvDefineFunction2(theEnv, "str-implode", 's', PTIEF ImplodeFunction,
                     "ImplodeFunction", "11m");
  EnvDefineFunction2(theEnv, "str-explode", 'm', PTIEF ExplodeFunction,
                     "ExplodeFunction", "11s");
  EnvDefineFunction2(theEnv, "subset", 'b', PTIEF SubsetpFunction,
                     "SubsetpFunction", "22*mm");
  EnvDefineFunction2(theEnv, "nth", 'u', PTIEF NthFunction, "NthFunction",
                     "22*im");
  EnvDefineFunction2(theEnv, "mv-replace", 'm', PTIEF MVReplaceFunction,
                     "MVReplaceFunction", "33*im");
  EnvDefineFunction2(theEnv, "member", 'u', PTIEF MemberFunction,
                     "MemberFunction", "22*um");
  EnvDefineFunction2(theEnv, "mv-subseq", 'm', PTIEF MVSubseqFunction,
                     "MVSubseqFunction", "33*iim");
  EnvDefineFunction2(theEnv, "mv-delete", 'm', PTIEF MVDeleteFunction,
                     "MVDeleteFunction", "22*im");
#if !BLOAD_ONLY
  ...
  EnvDefineFunction2(theEnv, "(get-progn$-field)", 'u', PTIEF GetMvPrognField,
                     "GetMvPrognField", "00");
  EnvDefineFunction2(theEnv, "(get-progn$-index)", 'l', PTIEF GetMvPrognIndex,
                     "GetMvPrognIndex", "00");
#endif
}
...
globle void DeleteFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  if (DeleteMultiValueField(theEnv, returnValue, &value1,
                            (long)DOToLong(value2), (long)DOToLong(value3),
                            "delete$") == FALSE) /* TBD */
  {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
...
globle void MVDeleteFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  if (DeleteMultiValueField(theEnv, returnValue, &value2,
                            (long)DOToLong(value1), (long)DOToLong(value1),
                            "mv-delete") == FALSE) /* TBD */
  {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
...
globle void ReplaceFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  if (ReplaceMultiValueField(theEnv, returnValue, &value1,
                             (long)DOToLong(value2), (long)DOToLong(value3),
                             &value4, "replace$") == FALSE) /* TBD */
  {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
  }
...
globle void MVReplaceFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  if ((EnvArgTypeCheck(theEnv, "mv-replace", 1, INTEGER, &value1) == FALSE) ||
      (EnvArgTypeCheck(theEnv, "mv-replace", 2, MULTIFIELD, &value2) ==
       FALSE)) {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
    return;
  ...
  if (ReplaceMultiValueField(theEnv, returnValue, &value2,
                             (long)DOToLong(value1), (long)DOToLong(value1),
                             &value3, "mv-replace") == FALSE) /* TBD */
  {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
  }
...
globle void DeleteMemberFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  /* Check for the correct argument types. */
  /*=======================================*/
  if (EnvArgTypeCheck(theEnv, "delete-member$", 1, MULTIFIELD, &resultValue) ==
      FALSE) {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
    return;
  ...
  while (FindDOsInSegment(delVals, argCnt - 1, &resultValue, &j, &k, NULL, 0)) {
    if (DeleteMultiValueField(theEnv, &tmpVal, &resultValue, j, k,
                              "delete-member$") == FALSE) {
      rm(theEnv, (void*)delVals, delSize);
      SetEvaluationError(theEnv, TRUE);
      EnvSetMultifieldErrorValue(theEnv, returnValue);
...
globle void ReplaceMemberFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  /* Check for the correct argument types. */
  /*=======================================*/
  if (EnvArgTypeCheck(theEnv, "replace-member$", 1, MULTIFIELD, &resultValue) ==
      FALSE) {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
    return;
  ...
  if (GetType(replVal) == MULTIFIELD) replLen = GetDOLength(replVal);
  ...
  minkp = NULL;
  while (FindDOsInSegment(delVals, argCnt - 2, &resultValue, &j, &k, minkp,
                          minkp ? 1 : 0)) {
    if (ReplaceMultiValueField(theEnv, &tmpVal, &resultValue, j, k, &replVal,
...
globle void InsertFunction(void* theEnv, DATA_OBJECT_PTR returnValue) {
  ...
  if (InsertMultiValueField(theEnv, returnValue, &value1,
                            (long)DOToLong(value2), /* TBD */
                            &value3, "insert$") == FALSE) {
    SetEvaluationError(theEnv, TRUE);
    EnvSetMultifieldErrorValue(theEnv, returnValue);
  }
...
globle void MemberFunction(void* theEnv, DATA_OBJECT_PTR result) {
  ...
  if (EnvArgTypeCheck(theEnv, "member$", 2, MULTIFIELD, &item2) == FALSE)
    return;
...
/***************************************/
/* 6.05 Bug Fix */
intBool FindDOsInSegment(DATA_OBJECT_PTR searchDOs, int scnt,
                         DATA_OBJECT_PTR value, long* si, long* ei,
                         long* excludes, int epaircnt) {
  ...
  for (i = 0; i < mul_length; i++) {
    for (j = 0; j < scnt; j++) {
      if (GetType(searchDOs[j]) == MULTIFIELD) {
        ...
        if (MVRangeCheck(i + 1L, i + slen, excludes, epaircnt)) {
          for (k = 0L; (k < slen) && ((k + i) < mul_length); k++)
            if ((GetMFType(GetValue(searchDOs[j]),
                           k + GetDOBegin(searchDOs[j])) !=
                 GetMFType(GetpValue(value), k + i + GetpDOBegin(value))) ||
                (GetMFValue(GetValue(searchDOs[j]),
                            k + GetDOBegin(searchDOs[j])) !=
      ...
      } else if ((GetValue(searchDOs[j]) ==
                  GetMFValue(GetpValue(value), i + GetpDOBegin(value))) &&
                 (GetType(searchDOs[j]) ==
                  GetMFType(GetpValue(value), i + GetpDOBegin(value))) &&
...
/* MVRangeCheck:  */
/******************************************************/
static intBool MVRangeCheck(long si, long ei, long* elist, int epaircnt) {
  int i;

  if (!elist || !epaircnt) return (TRUE);
...
/******************************************************/
static struct expr* MultifieldPrognParser(void* theEnv, struct expr* top,
                                          const char* infile) {
  ...
  if (tkn.type != LPAREN) {
    ...
    if (tkn.type != SF_VARIABLE) {
      if (tkn.type != SYMBOL) goto MvPrognParseError;
    ...
    /* =========================================
      ...
      GetToken(theEnv, infile, &tkn);
      if (tkn.type != RPAREN) goto MvPrognParseError;
      PPBackup(theEnv);
      /* PPBackup(theEnv); */
  ...
  while (newBindList != NULL) {
    if ((fieldVar == NULL) ? FALSE
                           : (strcmp(ValueToString(newBindList->name),
                                     ValueToString(fieldVar)) == 0)) {
      ClearParsedBindNames(theEnv);
      SetParsedBindNames(theEnv, oldBindList);
...
/******************************************************/
static struct expr* ForeachParser(void* theEnv, struct expr* top,
                                  const char* infile) {
  struct BindInfo *oldBindList, *newBindList, *prev;
  struct token tkn;
  struct expr* tmp;
...
/**********************************************/
static void ReplaceMvPrognFieldVars(void* theEnv, SYMBOL_HN* fieldVar,
                                    struct expr* theExp, int depth) {
  size_t flen;

  flen = strlen(ValueToString(fieldVar));
  while (theExp != NULL) {
    if ((theExp->type != SF_VARIABLE)
            ? FALSE
      ...
      if (ValueToString(theExp->value)[flen] == '\0') {
        ...
        theExp->argList =
            GenConstant(theEnv, INTEGER, EnvAddLong(theEnv, (long long)depth));
      ...
      if ((theExp->type == FCALL) &&
          ((theExp->value == (void*)FindFunction(theEnv, "progn$")) ||
  ...
  for (i = GetDOBegin(argval); i <= end; i++) {
    ...
    for (theExp = GetFirstArgument()->nextArg; theExp != NULL;
      ...
      if (EvaluationData(theEnv)->HaltExecution ||
        ...
        MultiFunctionData(theEnv)->FieldVarStack = tmpField->nxt;
        rtn_struct(theEnv, fieldVarStack, tmpField);
        RestorePriorGarbageFrame(theEnv, &newGarbageFrame, oldGarbageFrame,
                                 result);
        return;
      }
 ...
 **************************************************************************/
globle int ReplaceMultiValueField(void* theEnv, DATA_OBJECT* dst,
                                  DATA_OBJECT* src, long rb, long re,
                                  DATA_OBJECT* field, const char* funcName) {
  long i, j, k;
  struct field* deptr;
  struct field* septr;
  long srclen, dstlen;
...
/**************************************************************************
  ...
  NOTES        : index is NOT guaranteed to be valid
                 src is guaranteed to be a multi-field variable or NULL
 **************************************************************************/
globle int InsertMultiValueField(void* theEnv, DATA_OBJECT* dst,
                                 DATA_OBJECT* src, long theIndex,
                                 DATA_OBJECT* field, const char* funcName) {
  long i, j, k;
  FIELD *deptr, *septr;
  long srclen, dstlen;
  ...
  dstlen =
      (field->type == MULTIFIELD) ? GetpDOLength(field) + srclen : srclen + 1;
  dst->value = EnvCreateMultifield(theEnv, dstlen);
  SetpDOEnd(dst, dstlen);
  theIndex--;
...
/*******************************************************
  ...
  NOTES        : None
 ******************************************************/
static void MVRangeError(void* theEnv, long brb, long bre, long max,
                         const char* funcName) {
...
/**************************************************************************
  ...
  NOTES        : index is NOT guaranteed to be valid
                 src is guaranteed to be a multi-field variable or NULL
 **************************************************************************/
globle int DeleteMultiValueField(void* theEnv, DATA_OBJECT* dst,
                                 DATA_OBJECT* src, long rb, long re,
                                 const char* funcName) {
  long i, j;
