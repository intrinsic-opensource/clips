...
LOCALE void* FindNamedConstructInModuleOrImports(void*, const char*,
                                                 struct construct*);
...
LOCALE SYMBOL_HN* GetConstructModuleCommand(void*, const char*,
                                            struct construct*);
LOCALE struct defmodule* GetConstructModule(void*, const char*,
                                            struct construct*);
...
LOCALE void ListConstruct(void*, struct construct*, const char*,
                          struct defmodule*);
...
LOCALE void DoForAllConstructsInModule(void*, void*,
                                       void (*)(void*, struct constructHeader*,
                                                void*),
                                       int, int, void*);
LOCALE void InitializeConstructHeader(void*, const char*,
                                      struct constructHeader*, SYMBOL_HN*);
