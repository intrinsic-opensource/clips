...
LOCALE struct symbolHashNode* GetConstructNameAndComment(
    void*, const char*, struct token*, const char*,
    void* (*)(void*, const char*), int (*)(void*, void*), const char*, int, int,
    int, int);
LOCALE void ImportExportConflictMessage(void*, const char*, const char*,
