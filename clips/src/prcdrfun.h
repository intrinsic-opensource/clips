...
#define ProcedureFunctionData(theEnv) \
  ((struct procedureFunctionData*)GetEnvironmentData(theEnv, PRCDRFUN_DATA))
...
LOCALE intBool GetBoundVariable(void*, struct dataObject*,
