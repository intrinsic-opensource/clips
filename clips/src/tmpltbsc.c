...
#if !RUN_TIME
  EnvDefineFunction2(theEnv, "get-deftemplate-list", 'm',
                     PTIEF GetDeftemplateListFunction,
                     "GetDeftemplateListFunction", "01w");
  EnvDefineFunction2(theEnv, "undeftemplate", 'v', PTIEF UndeftemplateCommand,
                     "UndeftemplateCommand", "11w");
  EnvDefineFunction2(theEnv, "deftemplate-module", 'w',
                     PTIEF DeftemplateModuleFunction,
                     "DeftemplateModuleFunction", "11w");

#if DEBUGGING_FUNCTIONS
  EnvDefineFunction2(theEnv, "list-deftemplates", 'v',
                     PTIEF ListDeftemplatesCommand, "ListDeftemplatesCommand",
                     "01w");
  EnvDefineFunction2(theEnv, "ppdeftemplate", 'v', PTIEF PPDeftemplateCommand,
                     "PPDeftemplateCommand", "11w");
#endif
...
/*************************************************************/
#if !DEFFACTS_CONSTRUCT
static void ResetDeftemplates(void* theEnv) {
  struct fact* factPtr;
...
/*****************************************************************/
static void ClearDeftemplates(void* theEnv) {
...
/**********************************************/
static void SaveDeftemplates(void* theEnv, void* theModule,
...
globle void UndeftemplateCommand(void* theEnv) {
  UndefconstructCommand(theEnv, "undeftemplate",
                        DeftemplateData(theEnv)->DeftemplateConstruct);
}
...
globle intBool EnvUndeftemplate(void* theEnv, void* theDeftemplate) {
  return (Undefconstruct(theEnv, theDeftemplate,
                         DeftemplateData(theEnv)->DeftemplateConstruct));
}
...
globle void GetDeftemplateListFunction(void* theEnv,
  ...
  GetConstructListFunction(theEnv, "get-deftemplate-list", returnValue,
                           DeftemplateData(theEnv)->DeftemplateConstruct);
}
...
/***********************************************/
globle void EnvGetDeftemplateList(void* theEnv, DATA_OBJECT_PTR returnValue,
                                  void* theModule) {
...
globle void* DeftemplateModuleFunction(void* theEnv) {
  return (
      GetConstructModuleCommand(theEnv, "deftemplate-module",
                                DeftemplateData(theEnv)->DeftemplateConstruct));
}
...
globle void PPDeftemplateCommand(void* theEnv) {
  PPConstructCommand(theEnv, "ppdeftemplate",
                     DeftemplateData(theEnv)->DeftemplateConstruct);
}
...
/***************************************/
globle int PPDeftemplate(void* theEnv, const char* deftemplateName,
                         const char* logicalName) {
  return (PPConstruct(theEnv, deftemplateName, logicalName,
                      DeftemplateData(theEnv)->DeftemplateConstruct));
}
...
globle void ListDeftemplatesCommand(void* theEnv) {
  ListConstructCommand(theEnv, "list-deftemplates",
                       DeftemplateData(theEnv)->DeftemplateConstruct);
}
...
/*   for the list-deftemplates command.  */
/*****************************************/
globle void EnvListDeftemplates(void* theEnv, const char* logicalName,
                                void* theModule) {
  ListConstruct(theEnv, DeftemplateData(theEnv)->DeftemplateConstruct,
                logicalName, (struct defmodule*)theModule);
}
...
/*   the current watch value of a deftemplate.           */
/*********************************************************/
globle void EnvSetDeftemplateWatch(void* theEnv, unsigned newState,
                                   void* theTemplate) {
#if MAC_XCD
#pragma unused(theEnv)
#endif
...
/**********************************************************/
globle unsigned DeftemplateWatchAccess(void* theEnv, int code,
                                       unsigned newState,
                                       EXPRESSION* argExprs) {
#if MAC_XCD
#pragma unused(code)
  ...
  return (ConstructSetWatchAccess(
      theEnv, DeftemplateData(theEnv)->DeftemplateConstruct, newState, argExprs,
...
/*************************************************************************/
globle unsigned DeftemplateWatchPrint(void* theEnv, const char* logName,
...
#pragma unused(code)
  ...
  return (ConstructPrintWatchAccess(
      theEnv, DeftemplateData(theEnv)->DeftemplateConstruct, logName, argExprs,
      EnvGetDeftemplateWatch, EnvSetDeftemplateWatch));
}
...
globle void GetDeftemplateList(DATA_OBJECT_PTR returnValue, void* theModule) {
  EnvGetDeftemplateList(GetCurrentEnvironment(), returnValue, theModule);
}

#if DEBUGGING_FUNCTIONS

globle unsigned GetDeftemplateWatch(void* theTemplate) {
  return EnvGetDeftemplateWatch(GetCurrentEnvironment(), theTemplate);
}

globle void ListDeftemplates(const char* logicalName, void* theModule) {
  EnvListDeftemplates(GetCurrentEnvironment(), logicalName, theModule);
}

globle void SetDeftemplateWatch(unsigned newState, void* theTemplate) {
  EnvSetDeftemplateWatch(GetCurrentEnvironment(), newState, theTemplate);
}

#endif /* DEBUGGING_FUNCTIONS */

globle intBool Undeftemplate(void* theDeftemplate) {
