...
#define GetMFPtr(target, index) \
  (&(((struct field*)((struct multifield*)(target))->theFields)[index - 1]))
#define SetMFType(target, index, value)                                  \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1] \
       .type = (unsigned short)(value))
#define SetMFValue(target, index, val)                                   \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1] \
       .value = (void*)(val))
#define GetMFType(target, index) \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1].type)
#define GetMFValue(target, index) \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1].value)

#define EnvGetMFLength(theEnv, target) \
  (((struct multifield*)(target))->multifieldLength)
#define EnvGetMFPtr(theEnv, target, index) \
  (&(((struct field*)((struct multifield*)(target))->theFields)[index - 1]))
#define EnvSetMFType(theEnv, target, index, value)                       \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1] \
       .type = (unsigned short)(value))
#define EnvSetMFValue(theEnv, target, index, val)                        \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1] \
       .value = (void*)(val))
#define EnvGetMFType(theEnv, target, index) \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1].type)
#define EnvGetMFValue(theEnv, target, index) \
  (((struct field*)((struct multifield*)(target))->theFields)[index - 1].value)
