...
#define DefglobalBinaryData(theEnv) \
  ((struct defglobalBinaryData*)GetEnvironmentData(theEnv, GLOBLBIN_DATA))

#define DefglobalPointer(i) \
  ((struct defglobal*)(&DefglobalBinaryData(theEnv)->DefglobalArray[i]))
