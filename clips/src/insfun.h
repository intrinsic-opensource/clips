...
LOCALE int PutSlotValue(void*, INSTANCE_TYPE*, INSTANCE_SLOT*, DATA_OBJECT*,
                        DATA_OBJECT*, const char*);
LOCALE int DirectPutSlotValue(void*, INSTANCE_TYPE*, INSTANCE_SLOT*,
                              DATA_OBJECT*, DATA_OBJECT*);
LOCALE intBool ValidSlotValue(void*, DATA_OBJECT*, SLOT_DESC*, INSTANCE_TYPE*,
                              const char*);
...
LOCALE void PrintSlot(void*, const char*, SLOT_DESC*, INSTANCE_TYPE*,
                      const char*);
LOCALE void PrintInstanceNameAndClass(void*, const char*, INSTANCE_TYPE*,
                                      intBool);
