...
static int CreateReadStringSource(void*, const char*, const char*, size_t,
                                  size_t);
...
globle void InitializeStringRouter(void* theEnv) {
  AllocateEnvironmentData(theEnv, STRING_ROUTER_DATA,
                          sizeof(struct stringRouterData),
                          DeallocateStringRouterData);

  EnvAddRouter(theEnv, "string", 0, FindString, PrintString, GetcString,
               UngetcString, NULL);
}
...
/*******************************************/
static void DeallocateStringRouterData(void* theEnv) {
...
/*************************************************************/
static int FindString(void* theEnv, const char* fileid) {
...
/**************************************************/
static int PrintString(void* theEnv, const char* logicalName, const char* str) {
  struct stringRouter* head;
  ...
  genstrncpy(&head->writeString[head->currentPosition], str,
             (STD_SIZE)(head->maximumPosition - head->currentPosition) - 1);
...
/************************************************/
static int GetcString(void* theEnv, const char* logicalName) {
  struct stringRouter* head;
  int rc;
...
/****************************************************/
static int UngetcString(void* theEnv, int ch, const char* logicalName) {
  struct stringRouter* head;
#if MAC_XCD
#pragma unused(ch)
#endif
...
/************************************************/
globle int OpenStringSource(void* theEnv, const char* name, const char* str,
...
/******************************************************/
globle int OpenTextSource(void* theEnv, const char* name, const char* str,
...
/******************************************************************/
static int CreateReadStringSource(void* theEnv, const char* name,
...
/**********************************************/
globle int CloseStringSource(void* theEnv, const char* name) {
...
/******************************************************************/
globle int OpenStringDestination(void* theEnv, const char* name, char* str,
                                 size_t maximumPosition) {
  struct stringRouter* newStringRouter;
  char* theName;
...
/***************************************************/
globle int CloseStringDestination(void* theEnv, const char* name) {
...
/*******************************************************************/
static struct stringRouter* FindStringRouter(void* theEnv, const char* name) {
  struct stringRouter* head;
