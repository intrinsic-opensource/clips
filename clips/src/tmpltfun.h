...
LOCALE intBool EnvDeftemplateSlotDefaultValue(void*, void*, const char*,
                                              DATA_OBJECT*);
LOCALE void DeftemplateSlotCardinalityFunction(void*, DATA_OBJECT*);
LOCALE void EnvDeftemplateSlotCardinality(void*, void*, const char*,
                                          DATA_OBJECT*);
LOCALE void DeftemplateSlotAllowedValuesFunction(void*, DATA_OBJECT*);
LOCALE void EnvDeftemplateSlotAllowedValues(void*, void*, const char*,
                                            DATA_OBJECT*);
...
LOCALE int EnvDeftemplateSlotFacetExistP(void*, void*, const char*,
                                         const char*);
LOCALE void DeftemplateSlotFacetValueFunction(void*, DATA_OBJECT*);
LOCALE int EnvDeftemplateSlotFacetValue(void*, void*, const char*, const char*,
                                        DATA_OBJECT*);
