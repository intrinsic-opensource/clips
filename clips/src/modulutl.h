...
LOCALE void ListItemsDriver(void*, const char*, struct defmodule*, const char*,
                            const char*, void* (*)(void*, void*),
                            const char* (*)(void*),
                            void (*)(void*, const char*, void*),
                            int (*)(void*, void*));
LOCALE long DoForAllModules(void*, void (*)(struct defmodule*, void*), int,
                            void*);
LOCALE intBool ConstructExported(void*, const char*, struct symbolHashNode*,
