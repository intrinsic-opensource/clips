...
#define GetActiveInstance(theEnv) \
  ((INSTANCE_TYPE*)GetNthMessageArgument(theEnv, 0)->value)
...
LOCALE intBool DirectMessage(void*, SYMBOL_HN*, INSTANCE_TYPE*, DATA_OBJECT*,
                             EXPRESSION*);
LOCALE void EnvSend(void*, DATA_OBJECT*, const char*, const char*,
                    DATA_OBJECT*);
...
LOCALE HANDLER_LINK* JoinHandlerLinks(void*, HANDLER_LINK*[], HANDLER_LINK*[],
                                      SYMBOL_HN*);
