...
#define InstanceData(theEnv) \
  ((struct instanceData*)GetEnvironmentData(theEnv, INSTANCE_DATA))
...
LOCALE void* EnvGetNextInstanceInClassAndSubclasses(void*, void**, void*,
                                                    DATA_OBJECT*);
